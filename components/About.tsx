                ...
                {skills.map((skill, index) => {
                    return (
                        <div className="max-w-[4rem] flex flex-col items-center text-center gap-2" key={index}>
                            <Image width={70} height={70} src={skill.src} alt={`${skill.skill} icon`} className="hover:animate-jello-vertical" />
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-16">
                <div className="w-full md:w-1/2 flex flex-col gap-8">
                    ...
                    <div className="flex gap-8 items-center flex-col md:flex-row">
                        <Link className="rounded-full px-4 py-2 text-xs md:text-base bg-ani-indigo text-white" href="/about-me">Read More</Link>
