            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-16">
                <div className="w-full md:w-1/2 flex flex-col gap-8">
                    ...
                    <div className="flex gap-8 items-center flex-col md:flex-row">
                        <Link className="rounded-full bg-white text-ani-indigo px-4 py-2 text-xs md:text-base" href="/">Read More</Link>
                        <button className="rounded-full bg-gradient-to-b to-ani-red from-ani-yellow text-white px-4 py-2 flex gap-4 items-center w-fit text-xs md:text-base"><span>Resume</span><Image width={"20"} height={"20"} src="/icons/download-wh.svg" alt="download icon" /></button>
                    </div>
                </div>
                <div>
